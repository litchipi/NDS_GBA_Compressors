...
int main(int argc, char **argv) {
  ...
  else if (!strcicmp(argv[1], "-evb")) { cmd = CMD_CODE_11; vram = LZX_VRAM; }
  else if (!strcicmp(argv[1], "-ewb")) { cmd = CMD_CODE_11; vram = LZX_WRAM; }
  else if (!strcicmp(argv[1], "-evl")) { cmd = CMD_CODE_40; vram = LZX_VRAM; }
  else if (!strcicmp(argv[1], "-ewl")) { cmd = CMD_CODE_40; vram = LZX_WRAM; }
